...
import { Alert, Image, NativeModules, ScrollView, StyleSheet, Text, TouchableOpacity, View ,FlatList ,Dimensions} from 'react-native';
...
class HomeScreen extends Component {
  ...
  writeJson (){
    ...
    .then(async (image) => {
      ...
      Alert.alert('识别失败',"非常抱歉，暂时无法识别，请换张图片")
    });
  }
  DeleteJson (){
    RNFS.unlink(path1);
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          style={styles.button}
        >
          <Text style={styles.text}>拍照识别</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          style={styles.button}
        >
          <Text style={styles.text}>相册识别</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          style={styles.button}
        >
          <Text style={styles.text}>导入图片</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={async () => {var result =await RNFS.readFile(path1+'/classes.json','utf8');
        result = result.substr(0,result.length-1)+']';
        result1 = JSON.parse(result);
        console.log(result);
        this.props.navigation.navigate('Details');}} style={styles.button}>
        ...
        <TouchableOpacity
          ...
          style={styles.button}
        >
          <Text style={styles.text}>重置相册</Text>
        </TouchableOpacity>
      </View>
    );
  }
    ...
    return (
      ...
      <TouchableOpacity>
        <Text style={
                    ...
                    }}>逄小博{state}这张图片是{classes}</Text>
      </TouchableOpacity>
      <TouchableOpacity
          onPress={() => navigation.goBack()}
          style={styles.button}
        >
          <Text style={styles.text}>继续识别</Text>
      </TouchableOpacity>
      </View>
    )
}
  ...
  render() {
    return (
      ...
      this.props.navigation.navigate('Photo');}} style={{ backgroundColor: 'blue', flex:0.5,alignItems: 'center',height: 80, borderRadius: 12,justifyContent:'center' }}>
          <Text style={{color:'white', fontSize: 20,}}>{this.props.classes}</Text>
      </TouchableOpacity>
    )
  }
}
...
function App() {
  return (
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen name="Home" component={HomeScreen} options={{ title: '分类相册' }} />
