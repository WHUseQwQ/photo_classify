...
class CameraScreen extends PureComponent {
  ...
  takePicture = async () => {
    if (this.camera) {
      ...
      const response = await this.getCameraMessage(data);
